...
*/
public class Program3Employee
{
	 int employeeNumber;
	 String employeeName;
	 double employeeSalary;
	 
	 Program3Employee(int employeeNumber,String employeeName, double employeeSalary)
	{
		if(employeeNumber<0)
		{
			employeeNumber=0;
		...
		{
			employeeName=null;
			System.out.println("employeeName must be enter");
		}
		else{
